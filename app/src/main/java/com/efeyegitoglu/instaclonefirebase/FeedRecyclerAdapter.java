...
public class FeedRecyclerAdapter extends RecyclerView.Adapter<FeedRecyclerAdapter.PostHolder> {
    ...
    class PostHolder extends RecyclerView.ViewHolder{
        ...
        public PostHolder(@NonNull View itemView) {
            ...
            imageView = itemView.findViewById(R.id.rcyclerview_row_imageview);
            userEmailText = itemView.findViewById(R.id.rcyclerview_row_useremail_text);
            commentText = itemView.findViewById(R.id.rcyclerview_row_usercomment_text);
        }
    }
